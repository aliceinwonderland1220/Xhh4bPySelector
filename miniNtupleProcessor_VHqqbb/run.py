...
def runShell():
	...
	global filename
	# filename = os.environ["Xhh4bPySelector_dir"]+"/miniNtupleProcessor_VHqqbb/data/v02-01-01_update1/filelist_%s.txt" % (options.sampleName)
	filename = os.environ["Xhh4bPySelector_dir"]+"/miniNtupleProcessor_VHqqbb/data/vtmp/filelist_%s.txt" % (options.sampleName)
