...
# filename = os.environ["Xhh4bPySelector_dir"]+"/../hh4b_boosted_PassLeadSubLeadJetPt_v00-00-00_ttbar_allhad.root"
filename = os.environ["Xhh4bPySelector_dir"]+"/../hh4b_boosted_PassLeadSubLeadJetPt_v00-00-00_RSG.root"
...
def runProofLite():
	...
	proof = ROOT.TProof.Open("lite://", "workers=6")
